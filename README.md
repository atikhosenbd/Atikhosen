...
body#layout:before{content:'BuzzSpot - v1.0.0';position:absolute;top:0;left:5px;right:5px;height:95px;font-family:Roboto,sans-serif;font-size:23px;color:#263238;line-height:95px;text-align:center}
...
body#layout .main-logo,body#layout .x1c3a-main-menu{width:50%}
...
body#layout #x1c3a-about-section{overflow:hidden!important}
body#layout #x1c3a-about-section .widget{float:left;width:49.5%;margin-right:1%}
body#layout #x1c3a-about-section .LinkList{margin-right:0}
...
body#layout #x1c3a-main-menu > h4:after{content:' - Menu Links and Sub Links'}
body#layout #main > h4:after{content:' - Default Blog Posts, AdSense In-Feed, Comments and More'}
body#layout #x1c3a-related-posts > h4:after{content:' - Exclusive Non-Duplicate Post System'}
body#layout #sidebar > h4:after{content:' - Default Gadgets'}
body#layout #x1c3a-about-section > h4:after{content:' - Site Logo, Description and Social Icons'}
body#layout #footer-copyright > h4:after{content:' - Custom Credits'}
body#layout #footer-menu > h4:after{content:' - Footer Links'}
body#layout:after{content:'Design by - devsoffice.com';display:block;font-family:Roboto,sans-serif;font-size:14px;color:rgba(0,0,0,0.54);line-height:1;text-align:center;visibility:visible;padding:20px 0 30px}
  ...
  <b:defaultmarkup type='Common'>
    ...
    <b:includable id='image-content'>
      <b:if cond='data:widget.sectionId == &quot;pbt-panel&quot;'>
        ...
        <b:elseif cond='data:widget.sectionId == &quot;x1c3a-about-section&quot;'/>
  ...
  <b:defaultmarkup type='Blog'>
    ...
    <b:includable id='blogPostsTitle'>
      <b:if cond='data:blog.jumpLinkMessage != &quot;{hide}&quot;'>
        <div class='main-title-wrap blog1-title'><h3 class='title'><data:blog.jumpLinkMessage/></h3></div>
      </b:if>
    </b:includable>
    ...
    <b:includable id='ajaxPagination'>
      ...
      <div class='blog-pager' id='blog-pager'>
        <b:if cond='data:olderPageUrl'>
          <a class='blog-pager-older-link load-more btn' expr:data-load='data:olderPageUrl.canonical' href='#' id='x1c3a-load-more-link'><b:include data='{ message: &quot;loadMorePosts&quot; }' name='theme-custom-lang'/></a>
  ...
  <div id='theme-options' style='display:none'>
    <b:section class='pbt-panel' id='pbt-panel' maxwidgets='2' name='Theme Options' showaddelement='no'>
      <b:widget id='Image52' locked='true' title='Default Thumbnail' type='Image' visible='true'>
        <b:widget-settings>
          <b:widget-setting name='displayUrl'>https://devsoffice.com/en/favicon.png</b:widget-setting>
      ...
      <b:widget id='HTML50' locked='true' title='JSON Variables' type='HTML' visible='false'>
        <b:widget-settings>
...
<div id='outer-wrapper'>
  <header id='header-wrapper'>
    <div class='main-header'>
              ...
              <div class='flex-left'>
                ...
                <b:if cond='data:view.isLayoutMode or (data:widgets.Image any w =&gt; w.sectionId == &quot;main-logo&quot;)'>
                  <b:section class='main-logo' id='main-logo' maxwidgets='1' name='Header Logo' showaddelement='no'>
                    <b:widget id='Image50' locked='true' title='Atik Hosen' type='Image' visible='true'>
                      <b:widget-settings>
                        <b:widget-setting name='displayUrl'>https://devsoffice.com/en/favicon.png</b:widget-setting>
                        <b:widget-setting name='displayHeight'>150</b:widget-setting>
                        <b:widget-setting name='sectionWidth'>150</b:widget-setting>
      ...
      <b:include name='image-content'/>
                    ...
                    <b:widget id='Header1' locked='false' title='Atik Hosen (Header)' type='Header' visible='false'>
                      <b:widget-settings>
                        <b:widget-setting name='displayUrl'>https://devsoffice.com/en/favicon.png</b:widget-setting>
                        <b:widget-setting name='displayHeight'>150</b:widget-setting>
                        <b:widget-setting name='sectionWidth'>150</b:widget-setting>
        ...
        <b:tag class='blog-title' cond='!data:view.isMultipleItems' name='span'>
          <b:tag expr:href='data:blog.homepageUrl.canonical' name='a'>
            <data:title/>
                ...
                <b:section class='x1c3a-main-menu' id='x1c3a-main-menu' maxwidgets='1' name='Header Menu' showaddelement='no'>
                  <b:widget id='LinkList200' locked='true' title='primary menu' type='LinkList' visible='true'>
                    <b:widget-settings>
                      <b:widget-setting name='link-5'>https://atikhosenbd.blogspot.com/p/contact.html</b:widget-setting>
                      <b:widget-setting name='link-3'>https://atikhosenbd.blogspot.com/p/resources.html</b:widget-setting>
                      <b:widget-setting name='link-4'>https://atikhosenbd.blogspot.com/p/template.html</b:widget-setting>
                      <b:widget-setting name='text-1'>About</b:widget-setting>
                      <b:widget-setting name='text-0'>Home</b:widget-setting>
                      <b:widget-setting name='text-3'>Resources</b:widget-setting>
                      <b:widget-setting name='text-2'>Blog</b:widget-setting>
                      <b:widget-setting name='text-5'>Contact </b:widget-setting>
                      <b:widget-setting name='text-4'>Template</b:widget-setting>
                      <b:widget-setting name='shownum'>10</b:widget-setting>
                      <b:widget-setting name='sorting'>NONE</b:widget-setting>
                      <b:widget-setting name='link-1'>https://atikhosenbd.blogspot.com/p/about.html</b:widget-setting>
                      <b:widget-setting name='link-2'>https://atikhosenbd.blogspot.com/p/blog.html</b:widget-setting>
                      <b:widget-setting name='link-0'>https://atikhosenbd.blogspot.com/p/home.html</b:widget-setting>
                    </b:widget-settings>
                    <b:includable id='main' var='this'>
      <b:include name='widget-title'/>
      <b:include name='content'/>
  ...
  <!-- LINT.ThenChange(//depot/google3/java/com/google/blogger/b2/layouts/widgets/v2-style.css) -->
        ...
        <b:section cond='data:view.isLayoutMode or (data:view.isPost and (data:widgets.HTML any w =&gt; w.sectionId == &quot;x1c3a-related-posts&quot;))' id='x1c3a-related-posts' maxwidgets='1' name='Related Posts' showaddelement='yes'>
      ...
      <b:include name='popular-content'/>
          ...
          <b:widget id='LinkList1' locked='false' title='Follow Us' type='LinkList' visible='true'>
            <b:widget-settings>
              <b:widget-setting name='link-3'>https://www.youtube.com/@atikhosenbd/ # 65k</b:widget-setting>
              <b:widget-setting name='sorting'>NONE</b:widget-setting>
              <b:widget-setting name='link-4'>https://instagram.com/atikhosenbd/ # 23k</b:widget-setting>
              <b:widget-setting name='text-1'>facebook</b:widget-setting>
              <b:widget-setting name='link-1'>https://www.facebook.com/atikhosenofficeal/ # 25k</b:widget-setting>
              <b:widget-setting name='text-0'>{getSocial}</b:widget-setting>
              <b:widget-setting name='link-2'>https://x.com/atikhosenbd/ # 39k</b:widget-setting>
      ...
      <b:include name='linklist-content'/>
          ...
          <b:widget id='HTML19' locked='false' title='{getMailchimp} $title={MailChimp Form} $text={Subscribe to our mailing list to get the new updates.}' type='HTML' visible='true'>
            <b:widget-settings>
  ...
  <b:include name='reportAbuse'/>
          ...
          <b:widget id='LinkList2' locked='false' title='Follow Us' type='LinkList' visible='false'>
            <b:widget-settings>
              <b:widget-setting name='link-3'>https://instagram.com/templateifydotcom</b:widget-setting>
              <b:widget-setting name='sorting'>NONE</b:widget-setting>
              ...
              <b:widget-setting name='link-2'>https://www.youtube.com/c/Templateify_Blogger</b:widget-setting>
      ...
      <b:include name='linklist-content'/>
          ...
          <b:widget id='Text1' locked='false' title='About Us' type='Text' visible='false'>
            <b:widget-settings>
              <b:widget-setting name='content'><![CDATA[Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an... <a href="https://www.templateify.com/" target="_blank">more →</a>]]></b:widget-setting>
            </b:widget-settings>
            <b:includable id='main'>
      <b:include name='text-content'/>
    </b:includable>
          </b:widget>
          <b:widget id='TextList150' locked='false' title='Facebook SDK' type='TextList' visible='true'>
            <b:includable id='main' var='this'>
      <b:include name='widget-title'/>
      <b:include name='content'/>
    </b:includable>
      ...
      <div class='widget-content'>
        <ul class='text-list list-style'>
          ...
          <b:widget id='Profile2' locked='false' title='About Me' type='Profile' visible='false'>
            <b:widget-settings>
  ...
  <a class='profile-link' expr:href='data:userUrl' rel='author nofollow'>
    <data:messages.viewMyCompleteProfile/>
          ...
          <b:widget id='FeaturedPost1' locked='false' title='Web Development' type='FeaturedPost' visible='false'>
            <b:widget-settings>
      ...
      <div class='featured-post'>
        <a class='entry-inner' expr:href='data:post.url.canonical' expr:title='data:post.title ? data:post.title : data:messages.noTitle'>
          <span class='entry-image-link before-mask'><b:if cond='data:post.featuredImage'><span class='entry-image' expr:data-src='data:post.featuredImage.isYouTube ? resizeImage(data:post.featuredImage.youtubeMaxResDefaultUrl.jsonEscaped, 72, &quot;1:1&quot;) : resizeImage(data:post.featuredImage, 72, &quot;1:1&quot;)'/><b:else/><span class='entry-image' data-src='https://resources.blogblog.com/img/blank.gif'/></b:if><b:class expr:name='data:post.featuredImage.isYouTube ? &quot;is-video&quot; : &quot;is-image&quot;'/></span>
          ...
          <b:widget id='BlogSearch150' locked='false' title='Mockups, Images, Icons, Card Templates...' type='BlogSearch' visible='false'>
            <b:includable id='main'>
      <b:include name='widget-title'/>
      <b:include name='content'/>
    </b:includable>
      ...
      <input class='search-action btn' expr:value='data:messages.ok' type='submit'/>
          ...
          <b:widget id='BloggerButton1' locked='false' title='' type='BloggerButton' visible='false'>
            <b:widget-settings>
              <b:widget-setting name='button'>https://resources.blogblog.com/html/buttons/blogger-simple-white.gif</b:widget-setting>
            </b:widget-settings>
            <b:includable id='main'>
 <div class='widget-content'>
    <a href='https://www.blogger.com' rel='nofollow'>
      <img alt='Powered by Blogger' expr:src='data:source' expr:srcset='data:srcset' width='128'/>
          ...
          <b:widget id='Image5' locked='false' title='Books &amp;amp; eBooks' type='Image' visible='false'>
            <b:widget-settings>
              <b:widget-setting name='displayUrl'>https://1.bp.blogspot.com/-QXzmzuVByZo/YV9mXhE_2eI/AAAAAAAAAmA/qCRUhqu6PBAvP91pysqQZ7VKXqO4sSJIACLcBGAsYHQ/s800/pbt-b-6.jpg</b:widget-setting>
              <b:widget-setting name='displayHeight'>342</b:widget-setting>
              <b:widget-setting name='sectionWidth'>150</b:widget-setting>
              <b:widget-setting name='shrinkToFit'>false</b:widget-setting>
              <b:widget-setting name='displayWidth'>800</b:widget-setting>
              <b:widget-setting name='link'>/search/label/Books</b:widget-setting>
              <b:widget-setting name='caption'>Need to Read More?</b:widget-setting>
            </b:widget-settings>
            <b:includable id='main' var='this'>
      <b:include name='widget-title'/>
      <b:include name='content'/>
      ...
      <b:include name='image-content'/>
          ...
          <b:widget id='Image4' locked='false' title='Cars &amp;amp; Scooters' type='Image' visible='false'>
            <b:widget-settings>
              <b:widget-setting name='displayUrl'>https://1.bp.blogspot.com/-3s2IOkkoZiM/YQWscBBQLFI/AAAAAAAAASk/7mTlbysrKMoYeKoVbwh2EOHPFCjzNuliwCLcBGAsYHQ/s800/pbt33.jpg</b:widget-setting>
              <b:widget-setting name='displayHeight'>450</b:widget-setting>
              <b:widget-setting name='sectionWidth'>150</b:widget-setting>
              <b:widget-setting name='shrinkToFit'>false</b:widget-setting>
              <b:widget-setting name='displayWidth'>800</b:widget-setting>
              <b:widget-setting name='link'>/search/label/Luxury%20Cars</b:widget-setting>
              <b:widget-setting name='caption'>Looking for a Car?</b:widget-setting>
            </b:widget-settings>
            <b:includable id='main' var='this'>
      <b:include name='widget-title'/>
      <b:include name='content'/>
  ...
  <div class='widget-content'>
    ...
    <b:else/>
      <b:include name='defaultAdUnit'/>
          ...
          <b:widget id='Image3' locked='false' title='Mobile Phones' type='Image' visible='false'>
            <b:widget-settings>
              <b:widget-setting name='displayUrl'>https://1.bp.blogspot.com/-pF0-2MwGV6I/YV8bnQumQ4I/AAAAAAAAAkk/Qy-pHEW1tzMSZG99p_vBcc4kdxxaIaJGACLcBGAsYHQ/s800/pbt-p-1.jpg</b:widget-setting>
              <b:widget-setting name='displayHeight'>533</b:widget-setting>
              <b:widget-setting name='sectionWidth'>150</b:widget-setting>
              <b:widget-setting name='shrinkToFit'>false</b:widget-setting>
              <b:widget-setting name='displayWidth'>800</b:widget-setting>
              <b:widget-setting name='link'>/search/label/Smartphones</b:widget-setting>
              <b:widget-setting name='caption'>Looking for a Phone?</b:widget-setting>
            </b:widget-settings>
            <b:includable id='main' var='this'>
      <b:include name='widget-title'/>
      <b:include name='content'/>
  ...
  <div class='widget-content'>
    ...
    <b:else/>
      <b:include name='defaultAdUnit'/>
          ...
          <b:widget id='Image2' locked='false' title='Gadgets &amp;amp; Consoles' type='Image' visible='false'>
            <b:widget-settings>
              <b:widget-setting name='displayUrl'>https://1.bp.blogspot.com/-UO9L7X5Pjgw/YQW9KU32jgI/AAAAAAAAAVc/cqJa2nMh_hcKJrMDGIq8DnHyOkgVxkAGgCLcBGAsYHQ/s800/pbt55.jpg</b:widget-setting>
              <b:widget-setting name='displayHeight'>533</b:widget-setting>
              <b:widget-setting name='sectionWidth'>150</b:widget-setting>
              <b:widget-setting name='shrinkToFit'>false</b:widget-setting>
              <b:widget-setting name='displayWidth'>800</b:widget-setting>
              <b:widget-setting name='link'>/search/label/Gadgets</b:widget-setting>
              <b:widget-setting name='caption'>Electronics?</b:widget-setting>
            </b:widget-settings>
            <b:includable id='main' var='this'>
      <b:include name='widget-title'/>
      <b:include name='content'/>
      ...
      <b:include name='image-content'/>
          ...
          <b:widget id='Image1' locked='false' title='Houses &amp;amp; Apartments' type='Image' visible='false'>
            <b:widget-settings>
              <b:widget-setting name='displayUrl'>https://1.bp.blogspot.com/-BGnQIXAxnJ4/YV8MKKAliII/AAAAAAAAAkM/GeqSGUtC6iIlHBimCYRPNMBh7-FGXj2owCLcBGAsYHQ/s800/pbt-re-2.jpg</b:widget-setting>
              <b:widget-setting name='displayHeight'>533</b:widget-setting>
              <b:widget-setting name='sectionWidth'>150</b:widget-setting>
              <b:widget-setting name='shrinkToFit'>false</b:widget-setting>
              <b:widget-setting name='displayWidth'>800</b:widget-setting>
              <b:widget-setting name='link'>/search/label/Real%20Estate</b:widget-setting>
              <b:widget-setting name='caption'>Buy or Rent?</b:widget-setting>
            </b:widget-settings>
            <b:includable id='main' var='this'>
      <b:include name='widget-title'/>
      <b:include name='content'/>
      ...
      <b:include name='image-content'/>
          ...
          <b:widget id='LinkList152' locked='false' title='Main Menu' type='LinkList' visible='false'>
            <b:widget-settings>
              <b:widget-setting name='text-10'>Blogger</b:widget-setting>
              <b:widget-setting name='sorting'>NONE</b:widget-setting>
              <b:widget-setting name='link-1'>#</b:widget-setting>
              <b:widget-setting name='link-2'>#</b:widget-setting>
              <b:widget-setting name='link-12'>/p/shortcodes.html</b:widget-setting>
              <b:widget-setting name='link-0'>/</b:widget-setting>
              <b:widget-setting name='link-11'>/p/tipography.html</b:widget-setting>
              ...
              <b:widget-setting name='link-5'>/2020/07/flat-marketing-landing-page-template.html</b:widget-setting>
              <b:widget-setting name='link-6'>/2020/07/isometric-e-commerce-landing-pages-free.html</b:widget-setting>
              <b:widget-setting name='link-3'>#</b:widget-setting>
              <b:widget-setting name='link-4'>/2020/07/flat-design-shopping-online-landing.html</b:widget-setting>
      ...
      <b:include name='linklist-content'/>
          ...
          <b:widget id='Image150' locked='false' title='Premium Quality Fee Mockups, Make Right Here!' type='Image' visible='false'>
            <b:widget-settings>
              <b:widget-setting name='displayUrl'>http://4.bp.blogspot.com/-en4ZaBhkgSs/XsU3b3GpdOI/AAAAAAAACJo/7ktOtl1o0iouU_bzYctC82CEdMa4t2DVACK4BGAYYCw/s1600/Depositphotos_102339260_xl-2015.jpg</b:widget-setting>
              <b:widget-setting name='displayHeight'>1120</b:widget-setting>
              <b:widget-setting name='sectionWidth'>150</b:widget-setting>
              <b:widget-setting name='shrinkToFit'>false</b:widget-setting>
              <b:widget-setting name='displayWidth'>1600</b:widget-setting>
              <b:widget-setting name='link'>/</b:widget-setting>
              <b:widget-setting name='caption'>The biggest source of free photo-realistic mockup online</b:widget-setting>
            </b:widget-settings>
            <b:includable id='main' var='this'>
      <b:include name='widget-title'/>
      <b:include name='content'/>
      ...
      <b:include name='image-content'/>
          ...
          <b:widget id='PageList51' locked='false' title='Pages' type='PageList' visible='false'>
            <b:widget-settings>
              <b:widget-setting name='pageListJson'><![CDATA[{"link1":{"href":"#","position":1,"title":"Best Sellers"},"link0":{"href":"/","position":0,"title":"Home"},"link5":{"href":"#","position":5,"title":"Computers"},"link4":{"href":"#","position":4,"title":"Fashion"},"link3":{"href":"#","position":3,"title":"Electronics"},"link2":{"href":"#","position":2,"title":"Books"},"link6":{"href":"#","position":6,"title":"New Releases"}}]]></b:widget-setting>
      ...
      <b:include name='pagelist-content'/>
          ...
          <b:widget id='PageList1' locked='false' title='' type='PageList' visible='false'>
            <b:widget-settings>
              <b:widget-setting name='pageListJson'><![CDATA[{"link0":{"href":"http://atikhosenbd.blogspot.com/","position":0,"title":"Home"}}]]></b:widget-setting>
              <b:widget-setting name='homeTitle'>Home</b:widget-setting>
            </b:widget-settings>
            <b:includable id='main'>
      <b:include name='widget-title'/>
      ...
      <b:include name='pagelist-content'/>
          ...
          <b:widget id='PageList50' locked='false' title='Pages' type='PageList' visible='false'>
            <b:widget-settings>
              <b:widget-setting name='pageListJson'><![CDATA[{"link1":{"href":"#","position":1,"title":"Features"},"link0":{"href":"/","position":0,"title":"Home"},"link5":{"href":"#","position":5,"title":"__Left Sidebar"},"link4":{"href":"#","position":4,"title":"_Post Layouts"},"link3":{"href":"#","position":3,"title":"_Love Items"},"link13":{"href":"#","position":13,"title":"Shortcodes"},"link2":{"href":"#","position":2,"title":"_Intro Section"},"link9":{"href":"#","position":9,"title":"_RTL Support"},"link11":{"href":"#","position":11,"title":"Blogger Templates"},"link8":{"href":"#","position":8,"title":"_Error Page"},"link12":{"href":"#","position":12,"title":"Tipography"},"link7":{"href":"#","position":7,"title":"__Right Sidebar"},"link6":{"href":"#","position":6,"title":"__Full Width"},"link10":{"href":"#","position":10,"title":"_MailChimp"}}]]></b:widget-setting>
              <b:widget-setting name='homeTitle'>Home</b:widget-setting>
            </b:widget-settings>
            <b:includable id='main'>
      <b:include name='widget-title'/>
      ...
      <b:include name='pagelist-content'/>
          ...
          <b:widget id='HTML3' locked='false' title='{getMailchimp} $title={Mailchimp Form} $text={Subscribe to our mailing list to get the new updates.}' type='HTML' visible='false'>
            <b:widget-settings>
              <b:widget-setting name='content'><![CDATA[https://probloggertemplates.us6.list-manage.com/subscribe?u=98155398e3195ed8f58e2b86c&id=64e8605563]]></b:widget-setting>
            </b:widget-settings>
            <b:includable id='main'>
      <b:include name='html-content'/>
          ...
          <b:widget id='HTML150' locked='false' title='JSON Variables' type='HTML' visible='false'>
            <b:widget-settings>
              <b:widget-setting name='content'/>
            </b:widget-settings>
            <b:includable id='main'>
      <b:include name='html-content'/>
          ...
          <b:widget id='LinkList50' locked='false' title='Follow Us' type='LinkList' visible='false'>
            <b:widget-settings>
              <b:widget-setting name='link-5'>https://instagram.com/probloggertemplates # Instagram</b:widget-setting>
              <b:widget-setting name='link-3'>https://www.youtube.com/channel/UCxhJg3fukQC5w5etA7BP2jA?sub_confirmation=1 # YouTube</b:widget-setting>
              <b:widget-setting name='link-4'>https://www.linkedin.com/ # LinkedIn</b:widget-setting>
              <b:widget-setting name='text-1'>facebook</b:widget-setting>
              <b:widget-setting name='text-0'>{getSocial}</b:widget-setting>
              <b:widget-setting name='text-3'>youtube</b:widget-setting>
              <b:widget-setting name='text-2'>twitter</b:widget-setting>
              ...
              <b:widget-setting name='sorting'>NONE</b:widget-setting>
              <b:widget-setting name='link-1'>https://www.facebook.com/probloggertemplates # Facebook</b:widget-setting>
              <b:widget-setting name='link-2'>https://twitter.com/probtemplates # Twitter</b:widget-setting>
              <b:widget-setting name='link-0'>#</b:widget-setting>
            </b:widget-settings>
            <b:includable id='main' var='this'>
      <b:include name='widget-title'/>
      ...
      <b:include name='linklist-content'/>
          ...
          <b:widget id='HTML2' locked='false' title='' type='HTML' visible='false'>
            <b:widget-settings>
              <b:widget-setting name='content'><![CDATA[<a class="ads-here" href="https://www.templateify.com/2020/07/freebify-blogger-template.html"><img src="https://1.bp.blogspot.com/-TGjQKiW8Fj4/XwTtHbFJWVI/AAAAAAAACTM/YLcre4aIIv0Swn67Z922xF4fR-mMn3ZZACK4BGAYYCw/s1600/ad300.jpg" alt="Sidebar ADS"/></a>]]></b:widget-setting>
            </b:widget-settings>
            <b:includable id='main'>
      <b:include name='html-content'/>
    </b:includable>
          </b:widget>
          <b:widget id='PopularPosts2' locked='false' title='Trending' type='PopularPosts' visible='false'>
            <b:widget-settings>
      ...
      <b:include name='popular-content'/>
          ...
          <b:widget id='LinkList51' locked='false' title='Follow Us' type='LinkList' visible='false'>
            <b:widget-settings>
              <b:widget-setting name='link-5'>https://www.pinterest.com/probloggertemplates/</b:widget-setting>
              <b:widget-setting name='link-3'>https://www.youtube.com/channel/UCxhJg3fukQC5w5etA7BP2jA?sub_confirmation=1</b:widget-setting>
  ...
  <footer class='flex-col' id='footer-wrapper'>
    <b:if cond='data:view.isLayoutMode or (data:widgets.Image any w =&gt; w.sectionId == &quot;x1c3a-about-section&quot;)'>
      <div class='primary-footer flex-c'>
        <div class='container row-x1'>
          <b:section class='about-section flex-sb' id='x1c3a-about-section' maxwidgets='2' name='About Section' showaddelement='yes'>
            <b:widget id='Image51' locked='true' title='About Us' type='Image' visible='true'>
              <b:widget-settings>
                ...
                <b:widget-setting name='shrinkToFit'>false</b:widget-setting>
                <b:widget-setting name='displayWidth'>150</b:widget-setting>
                <b:widget-setting name='link'>https://devsoffice.com/en/favicon.png</b:widget-setting>
      ...
      <b:include name='image-content'/>
            ...
            <b:widget id='LinkList203' locked='true' title='Follow Us' type='LinkList' visible='true'>
              <b:widget-settings>
                <b:widget-setting name='link-5'>https://www.pinterest.com/atikhosenbd/</b:widget-setting>
                <b:widget-setting name='link-3'>https://www.youtube.com/channel/atikhosenbd</b:widget-setting>
                <b:widget-setting name='link-4'>https://instagram.com/atikhosenbd</b:widget-setting>
                <b:widget-setting name='text-1'>facebook</b:widget-setting>
                <b:widget-setting name='text-0'>{getSocial}</b:widget-setting>
                <b:widget-setting name='text-3'>youtube</b:widget-setting>
                <b:widget-setting name='text-2'>twitter</b:widget-setting>
                ...
                <b:widget-setting name='text-4'>instagram</b:widget-setting>
                <b:widget-setting name='sorting'>NONE</b:widget-setting>
                <b:widget-setting name='link-1'>https://www.facebook.com/atikhosenbd</b:widget-setting>
                <b:widget-setting name='link-2'>https://twitter.com/atikhosenbd</b:widget-setting>
                <b:widget-setting name='link-0'>#</b:widget-setting>
              </b:widget-settings>
              <b:includable id='main' var='this'>
      <b:include name='widget-title'/>
    ...
    <div class='footer-bar flex-c'>
      ...
      <div class='container row-x1 flex-sb'>
        <div class='footer-copyright' id='footer-copyright'>
          <span class='copyright-text'>© 2025 - <a href='https://devsoffice.com/' id='Devsoffice' title='Devsoffice'>Devsoffice.</a> | <a href='https://devsoffice.com'>devsoffice</a></span>
        </div>
        <b:section class='footer-menu' id='footer-menu' maxwidgets='1' name='Footer Menu' showaddelement='yes'>
          <b:widget id='LinkList204' locked='true' title='Footer menu' type='LinkList' visible='true'>
            <b:widget-settings>
              <b:widget-setting name='link-5'>https://atikhosenbd.blogspot.com/p/contact.html</b:widget-setting>
              <b:widget-setting name='link-3'>https://atikhosenbd.blogspot.com/p/resources.html</b:widget-setting>
              <b:widget-setting name='link-4'>https://atikhosenbd.blogspot.com/p/template.html</b:widget-setting>
              ...
              <b:widget-setting name='text-0'>Home</b:widget-setting>
              <b:widget-setting name='text-3'>Resources</b:widget-setting>
              <b:widget-setting name='text-2'>About </b:widget-setting>
              <b:widget-setting name='text-5'>Contact </b:widget-setting>
              <b:widget-setting name='text-4'>Template</b:widget-setting>
              <b:widget-setting name='shownum'>8</b:widget-setting>
              <b:widget-setting name='sorting'>NONE</b:widget-setting>
              <b:widget-setting name='link-1'>https://atikhosenbd.blogspot.com/p/blog.html</b:widget-setting>
              <b:widget-setting name='link-2'>https://atikhosenbd.blogspot.com/p/about.html</b:widget-setting>
              <b:widget-setting name='link-0'>https://atikhosenbd.blogspot.com/p/home.html</b:widget-setting>
            </b:widget-settings>
            <b:includable id='main' var='this'>
      <b:include name='widget-title'/>
      ...
      <b:include name='linklist-content'/>
          ...
          <b:widget id='LinkList155' locked='false' title='Link List' type='LinkList' visible='false'>
            <b:widget-settings>
      ...
      <b:include name='linklist-content'/>
          ...
          <b:widget id='PageList52' locked='false' title='Pages' type='PageList' visible='false'>
            <b:widget-settings>
              <b:widget-setting name='pageListJson'><![CDATA[{"link1":{"href":"#","position":1,"title":"About Us"},"link0":{"href":"/","position":0,"title":"Home"},"link3":{"href":"#","position":3,"title":"Contact Us"},"link2":{"href":"#","position":2,"title":"Privacy Policy"}}]]></b:widget-setting>
              <b:widget-setting name='homeTitle'>Home</b:widget-setting>
            </b:widget-settings>
            <b:includable id='main'>
      <b:include name='widget-title'/>
